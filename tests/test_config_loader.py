...
class TestLoadRules(unittest.TestCase):
    ...
    def test_load_default_rules_file(self):
        ...
        if os.path.exists(default_path):
            ...
            self.assertIn("family_type_names", result)
            self.assertIn("socket_kitchen_fridge", result["family_type_names"])
    ...
    def test_socket_defaults(self):
        ...
        try:
            ...
            self.assertEqual(result["kitchen_fridge_height_mm"], 300)
