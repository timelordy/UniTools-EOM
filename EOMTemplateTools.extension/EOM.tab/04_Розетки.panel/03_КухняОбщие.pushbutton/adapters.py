...
def pick_socket_symbol(doc, cfg, prefer):
    return su._pick_socket_symbol(doc, cfg, prefer, cache_prefix='socket_kitchen_general')
...
def collect_tagged_points(host_doc, tag_value):
    """Collect center points of instances with given comment tag."""
    pts = []
